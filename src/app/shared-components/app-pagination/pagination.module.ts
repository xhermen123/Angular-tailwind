...
import { PaginationCountsComponent } from './pagination-counts/pagination-counts.component';
...
@NgModule({
    ...
    exports: [PaginatePipe, PaginationControlsComponent, PaginationControlsDirective, PaginationCountsComponent]
})
